        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (url != null){
                    ...
                    Snackbar.make(findViewById(R.id.coordinatorLayaout), R.string.invalid_url, Snackbar.LENGTH_LONG).show();
                }
            }
        });
    }
            ...
            try {
                ...
                if (response == HttpURLConnection.HTTP_OK){
                    ...
                    try (BufferedReader reader = new BufferedReader(new InputStreamReader(connection.getInputStream()))){
                        ...
                        Snackbar.make(findViewById(R.id.coordinatorLayaout), R.string.read_error, Snackbar.LENGTH_LONG).show();
                        e.printStackTrace();
                    }
                    return  new JSONObject(builder.toString());
                }
                else {
                    Snackbar.make(findViewById(R.id.coordinatorLayaout),R.string.connect_error, Snackbar.LENGTH_LONG).show();
                }
            }
            catch (Exception e){
                Snackbar.make(findViewById(R.id.coordinatorLayaout),R.string.connect_error, Snackbar.LENGTH_LONG).show();
